...
const formSchema = z.object({
  ...
  contactMessage: z
    .string()
    .min(0, { message: "Message must be at least 10 characters" }),
});
  ...
  const contactInfo = [
    {
      ...
      title: "Our Location",
      content:
        "Dakhingaon Khanka Mini Tajmahal Road Insaf Nagar Path, Guwhatai, Assam ",
    },
    {
    ...
    },
    {
      ...
      title: "Email Address",
      content: "guwahaticityhomeservice@gmail.com",
    },
    {
          ...
          <div className="flex flex-col justify-between">
            <div>
              ...
              <p className="text-gray-600 mb-8">
                ...
                appointment? Get in touch with us using any of the methods
                below:
              </p>
            ...
            <div className="mt-8 h-60 rounded-lg overflow-hidden">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d685.8226431811893!2d91.7765405170494!3d26.125339433797297!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x375a5f879a9a5e31%3A0x25aef12f7e7415ca!2sMini%20Tajmahal!5e0!3m2!1sen!2sin!4v1747132583728!5m2!1sen!2sin"
                width="100%"
                height="100%"
                style={{ border: 0 }}
